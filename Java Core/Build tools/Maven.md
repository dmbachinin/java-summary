...
### Проверяет стиль кода на соответствие правилам
...
Название: `maven-enforcer-plugin (org.apache.maven.plugins)`
...
Название: `maven-war-plugin (org.apache.maven.plugins)`
